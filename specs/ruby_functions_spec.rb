...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    first_result = volume_of_cube(4)
    assert_equal(64,first_result)#add test code here
  end
  ...
  def test_fahrenheit_to_celsius()
    result_positive = farenheit_to_celsius(2)
    result_negative = farenheit_to_celsius(-5)
    assert_equal(-17, result_positive)
    assert_equal(-21, result_negative)
  end
